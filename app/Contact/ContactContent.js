...
const ContactContent = () => {
    ...
    const lesdivs = useTransform(
        scrollYProgress,
        [0, 1],
        ["-50", "10%"]
    )

    const lestext = useTransform(
        scrollYProgress,
        [0, 1],
        ["50", "0%"]
    )
        ...
        <>
            <motion.section ref={containerRef} >
                ...
                <div className="relative h-[500px] overflow-hidden">
                    ...
                    <motion.div animate={mainControls} initial="hidden" variants={{ hidden: { opacity: 0, y: 75 }, visible: { opacity: 1, y: 0, } }} className="absolute inset-0 text-gray-50 flex flex-col justify-center text-left p-8">
                        <h1 transition={{ delay: 0.3 }} className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">Nous joindre</h1>
                ...
                <motion.div animate={mainControls} initial="hidden" variants={{ hidden: { opacity: 0, y: 75 }, visible: { opacity: 1, y: 0, } }} className="container mx-auto px-4 py-8">
                    {/* Section Principale (Titre et Paragraphe) */}
                    <div variants={{ hidden: { opacity: 0 }, show: { opacity: 1 } }} className="text-center md:text-left mb-8">
                ...
                <motion.div style={{ translateX: lesdivs }} variants className="container bg-gray-100 mx-auto px-4 py-8">
                ...
                {/* la carte  */}
                <motion.div style={{ translateX: lestext }} variants className="container bg-red-200 mx-auto px-4 py-8">
